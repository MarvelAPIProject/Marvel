...
const translations = {
  "es": {
    ...
    "no.favorites": "No tienes favoritos aún",
    "discover.characters": "Descubrir personajes",
    "view.more": "Ver más",
    "no.description": "No hay descripción disponible para este personaje.",
    "no.description.general": "No hay descripción disponible.",
    "modal.universe": "Universo",
    "modal.comics": "Cómics",
    ...
    "toast.added": "{name} añadido a favoritos",
    "toast.removed": "{name} eliminado de favoritos",
    "search.comics": "¿Qué cómic buscas?",
    "search.series": "¿Qué serie buscas?",
    "search.events": "¿Qué evento buscas?",
    "search.movies": "¿Qué película buscas?",
    "search.favorites": "Buscar en tus favoritos",
    "error.loading": "Error al cargar la página. Inténtalo de nuevo.",
    "error.search": "Error al realizar la consulta. Por favor, intenta de nuevo.",
    "error.filter": "Error al aplicar el filtro. Inténtalo de nuevo.",
    "issue.number": "Número {number}",
    "year.label": "Año {year}"
  },
  "en": {
    "header.title": "Marvel",
    ...
    "footer.developed": "Developed by the CSS group",
    ...
    "footer.educational": "This site is an educational project with no commercial purposes.",
    "pagination.page": "Page",
    "pagination.of": "of",
    "pagination.characters": "characters",
    "pagination.loading": "Loading characters...",
    "contentFilters.title": "Filter by Type",
    "contentFilters.characters": "Characters",
    "contentFilters.comics": "Comics",
    "contentFilters.series": "Series",
    "contentFilters.events": "Events",
    "contentFilters.movies": "Movies",
    "contentFilters.favorites": "Favorites",
    "modal.addToFavorites": "Add to favorites",
    "modal.removeFromFavorites": "Remove from favorites",
    "no.favorites": "You have no favorites yet",
    "discover.characters": "Discover characters",
    "view.more": "View more",
    "no.description": "No description available for this character.",
    "no.description.general": "No description available.",
    "modal.universe": "Universe",
    "modal.comics": "Comics",
    ...
    "toast.added": "{name} added to favorites",
    "toast.removed": "{name} removed from favorites",
    "search.comics": "Which comic are you looking for?",
    "search.series": "Which series are you looking for?",
    "search.events": "Which event are you looking for?",
    "search.movies": "Which movie are you looking for?",
    "search.favorites": "Search in your favorites",
    "error.loading": "Error loading page. Please try again.",
    "error.search": "Error performing search. Please try again.",
    "error.filter": "Error applying filter. Please try again.",
    "issue.number": "Issue {number}",
    "year.label": "Year {year}"
  },
  "fr": {
    "header.title": "Marvel",
    "header.subtitle": "Explorez le vaste univers des personnages, comics et séries Marvel",
    "idioma": "Langue:",
    ...
    "character.comicsCount": "{count} comics disponibles",
    ...
    "contentFilters.title": "Filtrer par Type",
    "contentFilters.characters": "Personnages",
    "contentFilters.comics": "Comics",
    "contentFilters.series": "Séries",
    "contentFilters.events": "Événements",
    "contentFilters.movies": "Films",
    "contentFilters.favorites": "Favoris",
    "modal.addToFavorites": "Ajouter aux favoris",
    "modal.removeFromFavorites": "Retirer des favoris",
    "no.favorites": "Vous n'avez pas encore de favoris",
    "discover.characters": "Découvrir des personnages",
    "view.more": "Voir plus",
    "no.description": "Aucune description disponible pour ce personnage.",
    "no.description.general": "Aucune description disponible.",
    "modal.universe": "Univers",
    "modal.comics": "Bandes Dessinées",
    "modal.details": "Détails",
    "modal.years": "Années",
    "modal.dates": "Dates",
    "modal.year": "Année",
    "modal.description": "Description",
    "toast.added": "{name} ajouté aux favoris",
    "toast.removed": "{name} supprimé des favoris",
    "search.comics": "Quel comic cherchez-vous?",
    "search.series": "Quelle série cherchez-vous?",
    "search.events": "Quel événement cherchez-vous?",
    "search.movies": "Quel film cherchez-vous?",
    "search.favorites": "Rechercher dans vos favoris",
    "error.loading": "Erreur lors du chargement de la page. Veuillez réessayer.",
    "error.search": "Erreur lors de la recherche. Veuillez réessayer.",
    "error.filter": "Erreur lors de l'application du filtre. Veuillez réessayer.",
    "issue.number": "Numéro {number}",
    "year.label": "Année {year}"
  },
  "ro": {
    "header.title": "Marvel",
    "header.subtitle": "Explorează universul vast de personaje, benzi desenate și serii Marvel",
    "idioma": "Limbă:",
    "search.placeholder": "Ce supererou cauți?",
    "search.button": "Caută",
    ...
    "footer.marvelInfo": "Personajele și logourile Marvel sunt proprietatea <a href=\"https://developer.marvel.com/\" target=\"_blank\">Marvel Entertainment</a>",
    "footer.educational": "Acest site este un proiect educațional fără scopuri comerciale.",
    "pagination.page": "Pagina",
    "pagination.of": "din",
    "pagination.characters": "personaje",
    "pagination.loading": "Se încarcă personajele...",
    "contentFilters.title": "Filtrează după Tip",
    "contentFilters.characters": "Personaje",
    "contentFilters.comics": "Benzi desenate",
    "contentFilters.series": "Serii",
    "contentFilters.events": "Evenimente",
    "contentFilters.movies": "Filme",
    "contentFilters.favorites": "Favorite",
    "modal.addToFavorites": "Adaugă la favorite",
    "modal.removeFromFavorites": "Elimină din favorite",
    "no.favorites": "Nu ai încă favorite",
    "discover.characters": "Descoperă personaje",
    "view.more": "Vezi mai mult",
    "no.description": "Nu există descriere disponibilă pentru acest personaj.",
    "no.description.general": "Nu există descriere disponibilă.",
    "modal.universe": "Univers",
    "modal.comics": "Benzi Desenate",
    "modal.details": "Detalii",
    "modal.years": "Ani",
    "modal.dates": "Date",
    "modal.year": "An",
    "modal.description": "Descriere",
    "toast.added": "{name} adăugat la favorite",
    "toast.removed": "{name} eliminat din favorite",
    "search.comics": "Ce benzi desenate cauți?",
    "search.series": "Ce serie cauți?",
    "search.events": "Ce eveniment cauți?",
    "search.movies": "Ce film cauți?",
    "search.favorites": "Caută în favoritele tale",
    "error.loading": "Eroare la încărcarea paginii. Încercați din nou.",
    "error.search": "Eroare la efectuarea căutării. Încercați din nou.",
    "error.filter": "Eroare la aplicarea filtrului. Încercați din nou.",
    "issue.number": "Numărul {number}",
    "year.label": "Anul {year}"
  }
};
...
function initFilters() {
  ...
  if (universeFilters) {
    // Mostrar los filtros de universo si estamos en la pestaña de personajes
  ...
  try {
    ...
    fetchItems(currentContentFilter, '', currentPage, 'all')
      .then(items => {
        ...
        // Asegurar que los filtros de universo estén visibles si estamos en la pestaña de personajes
        const universeFilters = document.querySelector('.universe-filters');
        if (universeFilters && currentContentFilter === 'characters') {
          universeFilters.style.display = 'block';
        }
      })
      .catch(error => {
...
// Función para actualizar el texto de botones "Ver más"
function updateViewMoreButtons(lang) {
  if (!translations[lang] || !translations[lang]['view.more']) {
    console.warn('Missing translation for view.more in language:', lang);
    return;
  }
  ...
  // Actualizar cada botón con la traducción correcta
  viewMoreButtons.forEach(button => {
    button.textContent = translations[lang]['view.more'];
  });
}
  ...
  try {
    ...
    if (universeFilter !== 'all') {
      ...
      if (mappedUniverse) {
        ...
        console.warn(`Universo no mapeado: ${universeFilter}`);
...
function displayComics(comics) {
  ...
  comics.forEach(comic => {
    ...
    // Configure "View More" button - USAR TRADUCCIONES DEL SISTEMA
    comicsCount.classList.add('view-more-btn');
    comicsCount.textContent = translations[currentLang]['view.more'] || 'Ver más';
...
function setupUniverseFilters() {
  ...
  filterButtons.forEach(button => {
    ...
    newButton.addEventListener('click', async function() {
      ...
      // Verificar que el filtro existe en el mapeo
      if (filterValue !== 'all' && !universeMapping[filterValue]) {
        console.warn(`Filtro de universo no válido: ${filterValue}`);
        return;
      }
    ...
    newButton.addEventListener('click', async function() {
      ...
      if (universeFilters) {
        if (filterValue === 'characters') {
          universeFilters.style.display = 'block';
          // Asegurar que el botón "Todos" esté activo por defecto
          const allButton = document.querySelector('.filter-button[data-universe="all"]');
          if (allButton) {
            document.querySelectorAll('.filter-button').forEach(btn => 
              btn.classList.remove('active')
            );
...
async function applyFilter() {
  ...
  if (parent) {
    ...
    try {
      // Verificar que el filtro de universo es válido
      if (currentUniverseFilter !== 'all' && !universeMapping[currentUniverseFilter]) {
        console.warn(`Filtro de universo no válido: ${currentUniverseFilter}`);
        currentUniverseFilter = 'all';
      }
